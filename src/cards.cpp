...
dracula_ambush::dracula_ambush()
{
    ...
    Card_Value=2;
    Card_Boost_Value=3;
    owner=Fighters_Names::ANY;
    card_name_enum=cards::AMBUSH;
    effect=CARD_EFFECT_TYPE::DURING_COMBAT;
    type=CARD_TYPE::ATTACK;
    card_number=2;
...
dracula_baptism_of_blood::dracula_baptism_of_blood()
{
    ...
    Card_Value=0;
    Card_Boost_Value=2;
    card_name_enum=cards::BAPTISM_OF_BLOOD;
    owner=Fighters_Names::DRACULA;
    type=CARD_TYPE::SCHEME;
    card_number=2;
...
dracula_beastform::dracula_beastform()
{
    ...
    Card_Boost_Value=4;
    owner=Fighters_Names::DRACULA;
    card_name_enum=cards::BEASTFORM;
    effect=CARD_EFFECT_TYPE::DURING_COMBAT;
    type=CARD_TYPE::ATTACK;
    card_number=2;
...
dracula_look_into_my_eyes::dracula_look_into_my_eyes()
{
    ...
    Card_Boost_Value=2;
    owner=Fighters_Names::DRACULA;
    card_name_enum=cards::LOOK_INTO_MY_EYES;
    effect=CARD_EFFECT_TYPE::DURING_COMBAT;
...
dracula_prey_upon::dracula_prey_upon()
{
    ...
    Card_Boost_Value=4;
    owner=Fighters_Names::DRACULA;
    card_name_enum=cards::PREY_UPON;
    type=CARD_TYPE::SCHEME;
    card_number=2;
...
dracula_ravening_seduction::dracula_ravening_seduction()
{
    ...
    Card_Value=0;
    Card_Boost_Value=2;
    owner=Fighters_Names::SISTERS;
    card_name_enum=cards::RAVENING_SEDUCTION;
    type=CARD_TYPE::SCHEME;
    card_number=3;
...
dracula_thirst_For_sustenance::dracula_thirst_For_sustenance()
{
    ...
    owner=Fighters_Names::SISTERS;
    effect=CARD_EFFECT_TYPE::AFTER_COMBAT;
    card_name_enum=cards::THIRST_FOR_SUSTENANCE;
    type=CARD_TYPE::ATTACK;
    card_number=3;
...
holmes_administer_aid::holmes_administer_aid()
{
    ...
    card_name_enum=cards::AMINISTER_AID;
    type=CARD_TYPE::SCHEME;
    card_number=2;
...
holmes_confirm_suspicion::holmes_confirm_suspicion()
{
    ...
    Card_Value=0;
    Card_Boost_Value=1;
    owner=Fighters_Names::SHERLOCK;
    card_name_enum=cards::CONFIRM_SUSPICION;
    type=CARD_TYPE::SCHEME;
    card_number=3;
...
holmes_counterpunch::holmes_counterpunch()
{
    ...
    Card_Boost_Value=1;
    owner=Fighters_Names::SHERLOCK;
    card_name_enum=cards::COUNTERPUNCH;
    effect=CARD_EFFECT_TYPE::AFTER_COMBAT;
    type=CARD_TYPE::VERSATILE;
    card_number=3;
...
holmes_deduce_strategy::holmes_deduce_strategy()
{
    ...
    Card_Boost_Value=1;
    owner=Fighters_Names::SHERLOCK;
    card_name_enum=cards::DEDUCE_STRATEGY;
    effect=CARD_EFFECT_TYPE::DURING_COMBAT;
    type=CARD_TYPE::VERSATILE;
    card_number=3;
...
holmes_education_never_ends::holmes_education_never_ends()
{
    ...
    Card_Boost_Value=1;
    owner=Fighters_Names::ANY;
    card_name_enum=cards::EDUCATION_NEVER_ENDS;
    effect=CARD_EFFECT_TYPE::AFTER_COMBAT;
    type=CARD_TYPE::VERSATILE;
    card_number=2;\
...
holmes_elementary::holmes_elementary()
{
    ...
    Card_Boost_Value=3;
    owner=Fighters_Names::SHERLOCK;
    card_name_enum=cards::ELEMENTARY;
    effect=CARD_EFFECT_TYPE::DURING_COMBAT;
    type=CARD_TYPE::DEFENCE;
    card_number=2;
...
holmes_eliminate_the_impossible::holmes_eliminate_the_impossible()
{
    ...
    Card_Boost_Value=2;
    owner=Fighters_Names::SHERLOCK;
    card_name_enum=cards::ELIMINATE_THE_IMPOSSIBLE;
    type=CARD_TYPE::SCHEME;
    card_number=2;
...
holmes_fixed_point_in_a_changing_age::holmes_fixed_point_in_a_changing_age()
{
    ...
    owner=Fighters_Names::WATSON;
    effect=CARD_EFFECT_TYPE::AFTER_COMBAT;
    card_name_enum=cards::FIXED_POINT_IN_A_CHANGING_AGE;
    type=CARD_TYPE::VERSATILE;
    card_number=2;
...
holmes_master_of_disguise::holmes_master_of_disguise()
{
    ...
    Card_Boost_Value=2;
    owner=Fighters_Names::SHERLOCK;
    card_name_enum=cards::MASTER_OF_DISGUISE;
    type=CARD_TYPE::SCHEME;
    card_number=2;
...
holmes_the_game_is_afoot::holmes_the_game_is_afoot()
{
    ...
    Card_Boost_Value=2;
    owner=Fighters_Names::SHERLOCK;
    card_name_enum=cards::THE_GAME_IS_AFOOT;
    effect=CARD_EFFECT_TYPE::AFTER_COMBAT;
    type=CARD_TYPE::ATTACK;
    card_number=2;
...
holmes_study_methods::holmes_study_methods()
{
    ...
    owner=Fighters_Names::ANY;
    effect=CARD_EFFECT_TYPE::AFTER_COMBAT;
    card_name_enum=cards::STUDY_METHODS;
    type=CARD_TYPE::VERSATILE;
    card_number=2;
